...
(so you can edit a room you're looking into). `Y`/`H` brighten/darken the exact
surface under the crosshair — each **wall, floor and ceiling** has its own light, like
BUILD. The remaining keys act on the surface
